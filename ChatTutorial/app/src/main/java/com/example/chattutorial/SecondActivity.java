...
public class SecondActivity extends AppCompatActivity implements TextWatcher {
    ...
    private String SERVER_PATH="ws://192.168.43.20:3000";
...
else
{
    ...
    private class SocketListener extends WebSocketListener
    {
        ...
        public void onOpen(WebSocket webSocket, Response response) {
            ...
            runOnUiThread(()->
            {
                Toast.makeText(SecondActivity.this,"socket connection success",Toast.LENGTH_SHORT).show();
                initialiseView();
            });
        }
    ...
    private void initialiseView()
    {
        ...
        pickImgBtn=findViewById(R.id.picImgBtn);
